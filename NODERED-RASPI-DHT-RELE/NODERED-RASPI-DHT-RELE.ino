...
const char* ssid = "Labschool";
const char* password = "LabSchool!2018";

// Endereço do Servidor MQTT no Raspberry Pi IP 
const char* mqtt_server = "192.168.100.2";

// Inicia o espClient.
WiFiClient cecilCliente;
PubSubClient client(cecilCliente);
...
void loop() {
  ...
  // Publicando os valores de temperatura e humidade
    client.publish("cecil/T", temperatureTemp);
    client.publish("cecil/U", humidityTemp);
